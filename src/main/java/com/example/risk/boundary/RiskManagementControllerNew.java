...
import com.example.risk.control.management.RiskManagementFacadeNew;
...
@RestController
@AllArgsConstructor
public class RiskManagementControllerNew {

    private final RiskManagementFacadeNew riskManagementFacade;
    ...
    public RiskResults riskManagements() {
        ...
        riskManagementResults.add(linkTo(RiskManagementControllerNew.class).slash("api").slash("risk").withSelfRel());
...
//                        .withRel("sell-recommendation");
    ...
    private Link createSelfLink(RiskResult riskResult) {
        return linkTo(RiskManagementControllerNew.class)
                .slash("api")
                .slash("riskManagements")
