...
return (
  <div className="container">
    <table>
    <tbody>
    <tr><td className="header">Gesamtkapital</td><td>{riskManagement.totalCapital.toFixed(2)}</td></tr>
    <tr><td className="header">Einzelpositionrisiko</td><td>{riskManagement.individualPositionRiskInPercent.toFixed(2)}</td></tr>
    ...
    <tr>
        <td><b>Depotwert</b></td>
        <td colSpan={3}></td>
        <td className="number-content">{riskManagement.totalInvestment.toFixed(2)}</td>
        <td colSpan={2}></td>
        <td className="number-content">{riskManagement.totalRevenue.toFixed(2)}</td>
        <td className="number-content">{riskManagement.depotRisk.toFixed(2)}</td>
    </tr>
    <tr>
        <td className="header">Depotrisiko</td>
        <td colSpan={7}></td>
        <td className="number-content">{riskManagement.depotRiskInPercent.toFixed(2)}</td>
    </tr>
    <tr>
        <td className="header">Gesamtrisiko</td><td>{riskManagement.totalRiskInPercent.toFixed(2)}</td>
    </tr>
    </tbody>
    </table>
  </div>
